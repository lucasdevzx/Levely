...
import com.luken.levely.library.Library;
import com.luken.levely.trainingplanner.model.TrainingPlannerLibrary;
import com.luken.levely.trainingplanner.repository.TrainingPlannerLibraryRepository;
...
import com.luken.levely.social.like.LikeTrainingPlannerLibraryService;
import com.luken.levely.social.saved.SavedTrainingPlannerLibraryService;
     ...
     public TrainingPlannerLibrary findById(UUID trainingPlannerLibraryId) {
         return trainingPlannerLibraryRepository.findById(trainingPlannerLibraryId)
                 .orElseThrow(() -> new ResourceNotFoundException(
                         String.format("Entity training planner library not found by id: " + trainingPlannerLibraryId), ApiError.RESOURCE_NOT_FOUND));
     }
