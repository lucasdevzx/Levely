...
import com.luken.levely.setlog.dto.SetLogRequestDTO;
...
import com.luken.levely.daytraining.repository.DayTrainingWorkoutLogRepository;
...
public class DayTrainingWorkoutLogService {
    ...
    public DayTrainingWorkoutLog findByDayTrainingWorkoutId(UUID dayTrainingWorkoutId) {
        return dayTrainingWorkoutLogRepository.findByDayTrainingWorkoutId(dayTrainingWorkoutId)
                .orElseThrow(() -> new ResourceNotFoundException(
